...
//import tv.floe.metronome.deeplearning.dbn.iterativereduce.ParameterVector;
//import tv.floe.metronome.deeplearning.dbn.iterativereduce.ParameterVectorUpdateable;
//import tv.floe.metronome.deeplearning.dbn.iterativereduce.MasterNode;
...
public class Master implements ComputableMaster<ParameterVectorUpdateable> {
	...
	//	System.out.println("master update count: " + masterUpdates.size() );
		...
		ParameterVectorUpdateable masterReturnMsg = new ParameterVectorUpdateable();
		
		ParameterVectorUpdateable firstWorkerMsg = workerUpdates.iterator().next();
	    ...
	    for (ParameterVectorUpdateable dbn_worker : workerUpdates) {
	    ...
	    this.dbn_averaged_master.computeAverageParameterVector(workerDBNs);
...
//	    	System.out.println( "############## All Workers Are NOT Done w Current Dataset Epoch" );
		...
		ParameterVector dbn_update = new ParameterVector();
		...
		//ParameterVectorUpdateable updateable = new ParameterVectorUpdateable();
