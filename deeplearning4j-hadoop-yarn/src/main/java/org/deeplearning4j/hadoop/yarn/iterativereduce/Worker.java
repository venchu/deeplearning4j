...
//	watch.start();
	 ...
	 * 
	 */
	public ParameterVector GenerateParameterVectorUpdate() {
...
*/		
	...
	public ParameterVectorUpdateable getResults() {
		...
		return new ParameterVectorUpdateable( this.GenerateParameterVectorUpdate() );
	...
	public void update(ParameterVectorUpdateable master_update_updateable) {
		...
		ParameterVector master_update = master_update_updateable.get();
	...
	public static void main(String[] args) throws Exception {
		...
		ApplicationWorker<ParameterVectorUpdateable> aw = new ApplicationWorker<ParameterVectorUpdateable>(parser, wn, ParameterVectorUpdateable.class);
